...
public class DrugController{
    ...
    // public MidicineController( 
    //                           @Autowired MidicineRepository            midicineRepository, 
    //                           @Autowired TypesOfDrugsRepository        typesOfDrugsRepository,
    //                           @Autowired DrugRegistrationRepository    drugRegistrationRepository, 
    //                           @Autowired TypesOfDosageFormsRepository  typesOfDosageFormsRepository,
    //                           @Autowired DiseaseRepository             diseaseRepository
    // ){
    //     this.midicineRepository           = midicineRepository;
    //     this.typesOfDrugsRepository       = typesOfDrugsRepository;
    //     this.drugRegistrationRepository   = drugRegistrationRepository;
    //     this.typesOfDosageFormsRepository = typesOfDosageFormsRepository;
